...
INSERT INTO events (id, room_id, type, created_at, payload) VALUES ('1', 1, 'message', NOW() - 3, '{"id":"1","type":"message"}');
INSERT INTO events (id, room_id, type, created_at, payload) VALUES ('2', 1, 'message', NOW() - 2, '{"id":"2","type":"message"}');
